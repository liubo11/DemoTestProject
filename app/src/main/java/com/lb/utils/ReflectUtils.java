...
public class ReflectUtils {
    ...
    /**
     * 反射不带参数的 当前类的自有方法  一般用于hide的public方法反射
     * @param method 方法名称
     * @param object 类对象
     * @return may be null
     * @throws Exception
     */
    public static Object invokeMethod(String method, Object object) throws Exception {
        Method mt = getMethod(object.getClass(), false, false, method);
        if (null != mt) {
            return invokeMethod(mt, object);
        }
        return null;
    }
